  ...
  theme: {
    ...
    extend: {
      backgroundImage: {
        ...
        "gigs-desktop": "linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('/img/desktop/wedding-piano.webp')",
        "gigs-mobile": "linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('/img/desktop/wedding-piano.webp')"
      },
      fontFamily: {
        letsjazz: "letsjazz",
      },
